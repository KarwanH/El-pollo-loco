class HealthStatusBar extends DrawableObject {
  ...
  IMAGES = [
    ...
    "./img/7_statusbars/1_statusbar/2_statusbar_health/orange/20.png", // 20%
    "./img/7_statusbars/1_statusbar/2_statusbar_health/orange/40.png", // 40%
    "./img/7_statusbars/1_statusbar/2_statusbar_health/orange/60.png", // 60%
    "./img/7_statusbars/1_statusbar/2_statusbar_health/orange/80.png", // 80%
    "./img/7_statusbars/1_statusbar/2_statusbar_health/orange/100.png", // 100%
  ];
